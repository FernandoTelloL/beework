...
import { View, Text, Switch, Pressable, KeyboardAvoidingView, Platform } from "react-native";
...
const CustomizeCreateAccountScreen = () => {
  ...
  return (
    <KeyboardAvoidingView
      ...
      className="flex-1 bg-white py-4 w-[85%] mx-auto "
      keyboardVerticalOffset={100}
    >
      <View className="flex-1 justify-between font-poppins-regular">
          ...
          <View className="w-full">
            ...
            <View className="mb-6">
              ...
              <View className="flex-row justify-between items-center">
                <Text className="text-black-600 text-lg flex-1 mr-2 font-poppins-regular">
            ...
            {/* Segunda opción */}
            <View className="mb-6">
              <Text className="text-lg mb-1 font-poppins-bold pr-4">
